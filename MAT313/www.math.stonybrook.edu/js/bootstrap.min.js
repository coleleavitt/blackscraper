...
<!-- FILE NAME SUGGESTIONS:
   * html--js--bootstrap.min.js.tpl.php
   * html--js.tpl.php
   x html.tpl.php
-->
...
<body class="html not-front not-logged-in  page-js page-js-bootstrapminjs" >
...
<!-- FILE NAME SUGGESTIONS:
   x page.tpl.php
   * page--js--bootstrap.min.js.tpl.php
   * page--js.tpl.php
   x page.tpl.php
-->
...
<div id="block-search-form" class="block block-search">
  ...
  <div class="content">
    <form action="/js/bootstrap.min.js" method="post" id="search-block-form" accept-charset="UTF-8"><div>
...
<div class="form-actions form-wrapper" id="edit-actions"><input class="quick-nav--search-button form-submit" type="submit" id="edit-submit" name="op" value="" /></div><input type="hidden" name="form_build_id" value="form-rDbuvRq_c1hXmy8B1iTNgHUPGjmS1W9y1_USRCeDt7M" />
...
<!-- BEGIN OUTPUT from 'sites/all/themes/unity_lab/blocks/block--system--main.tpl.php' -->
    ...
    The requested page "/js/bootstrap.min.js" could not be found.
