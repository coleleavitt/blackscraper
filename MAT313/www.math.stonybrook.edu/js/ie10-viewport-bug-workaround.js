...
<!-- FILE NAME SUGGESTIONS:
   * html--js--ie10-viewport-bug-workaround.js.tpl.php
   * html--js.tpl.php
   x html.tpl.php
-->
...
<script type="text/javascript" src="jquery-extend-3.4.0.js"></script>
<script type="text/javascript" src="jquery-html-prefilter-3.5.0-backport.js"></script>
<script type="text/javascript" src="jquery.once.js"></script>
...
<body class="html not-front not-logged-in  page-js page-js-ie10-viewport-bug-workaroundjs" >
...
<!-- FILE NAME SUGGESTIONS:
   x page.tpl.php
   * page--js--ie10-viewport-bug-workaround.js.tpl.php
   * page--js.tpl.php
   x page.tpl.php
-->
...
<li class="quick-nav-stripes--list-item"><a href="/departmentmembers" title="" class="quick-nav-stripes--link">Members</a></li>
...
<div id="block-search-form" class="block block-search">
  ...
  <div class="content">
    <form action="/js/ie10-viewport-bug-workaround.js" method="post" id="search-block-form" accept-charset="UTF-8"><div>
...
<div class="form-actions form-wrapper" id="edit-actions"><input class="quick-nav--search-button form-submit" type="submit" id="edit-submit" name="op" value="" /></div><input type="hidden" name="form_build_id" value="form-pGJM_ihKJFTC048DyUK68-CDhPKCYBha7OzG7gd1Tvs" />
...
<!-- BEGIN OUTPUT from 'sites/all/themes/unity_lab/blocks/block--system--main.tpl.php' -->
    ...
    The requested page "/js/ie10-viewport-bug-workaround.js" could not be found.
