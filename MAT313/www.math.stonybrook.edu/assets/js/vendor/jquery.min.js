...
<!-- FILE NAME SUGGESTIONS:
   * html--assets--js--vendor--jquery.min.js.tpl.php
   * html--assets--js--vendor.tpl.php
   * html--assets--js.tpl.php
   * html--assets.tpl.php
   x html.tpl.php
-->
...
<body class="html not-front not-logged-in  page-assets page-assets-js page-assets-js-vendor page-assets-js-vendor-jqueryminjs" >
...
<!-- FILE NAME SUGGESTIONS:
   x page.tpl.php
   * page--assets--js--vendor--jquery.min.js.tpl.php
   * page--assets--js--vendor.tpl.php
   * page--assets--js.tpl.php
   * page--assets.tpl.php
   x page.tpl.php
-->
...
<div id="block-search-form" class="block block-search">
  ...
  <div class="content">
    <form action="/assets/js/vendor/jquery.min.js" method="post" id="search-block-form" accept-charset="UTF-8"><div>
...
<div class="form-actions form-wrapper" id="edit-actions"><input class="quick-nav--search-button form-submit" type="submit" id="edit-submit" name="op" value="" /></div><input type="hidden" name="form_build_id" value="form-4Cn-B156BPxXei-Rgqg1wsh1tokYxTMy5xPEpIuknmk" />
...
<!-- BEGIN OUTPUT from 'sites/all/themes/unity_lab/blocks/block--system--main.tpl.php' -->
    ...
    The requested page "/assets/js/vendor/jquery.min.js" could not be found.
